...
%> \endrst
%
classdef CrankRod < DAC_ODEclass
  ...
  methods
    function self = CrankRod( ell, m, gravity )
    ...
    function ode = f( self, t, Z )
      ...
      t45 = 0.1e1 / t44;
      t49 = 0.1e1 / (4 * t14 - 5);
      t51 = (t12 * t15 * t13 + L * t15 * t19 + L * (lambda_1 - 5 * lambda_3) * t24 + (-2 * t27 - 3 * t30) * t14 - 2 * L * (lambda_1 - 2 * lambda_3) * t13 + t27) * u_1 / t42 * t45 * t49;
      res_10 = -3 * t51;
