...
%
classdef DoubleSlider < DIAL_ODEsystem
  ...
  methods
    function this = DoubleSlider( ell, m, gravity )
      neq  = 8;
      ninv = 6;
      this@DIAL_ODEsystem( 'DoubleSlider', neq, ninv );
      this.ell     = ell;
      this.m       = m;
      this.gravity = gravity;
    end
    % - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    function res__f = f( this, t, vars__ )
      % extract parameters
      g = this.gravity;
      m = this.m;
      L = this.ell;
    ...
    % - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    function res__DfDx = DfDx( this, t, vars__ )
      % extract parameters
      g = this.gravity;
      m = this.m;
      L = this.ell;
    ...
    % - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    function res__DfDt = DfDt( this, t, vars__ )
      res__DfDt = zeros(8,1);
    end
    % - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    function res__h = h( this, t, vars__ )
      % extract parameters
      g = this.gravity;
      m = this.m;
      L = this.ell;
    ...
    % - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    function res__DhDx = DhDx( this, t, vars__ )
      % extract parameters
      g = this.gravity;
      m = this.m;
      L = this.ell;
    ...
    % - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    function res__DhDt = DhDt( this, t, vars__ )
      res__DhDt = zeros(6,1);
    end
    % - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    function plot( this, t, Z )
      DoubleSliderPlot( t, Z(1), Z(2), Z(3), this.ell );
    end
  end
end